// Game.js - A Simple WebGL game engine based on sim.js from WebGL Up and Running.

Game = {};

// Game.Publisher - base class for event publishers
Game.Publisher = function() {
    this.messageTypes = {};
}

Game.Publisher.prototype.subscribe = function(message, subscriber, callback) {
...
Game.Publisher.prototype.unsubscribe =  function(message, subscriber, callback) {
    if (subscriber)
    {
        var subscribers = this.messageTypes[message];
...
Game.Publisher.prototype.publish = function(message) {
    var subscribers = this.messageTypes[message];
...
Game.Publisher.prototype.findSubscriber = function (subscribers, subscriber) {
    for (var i = 0; i < subscribers.length; i++)
    {
...
// Game.App - application class (singleton)
Game.App = function()
{
...
Game.App.prototype = new Game.Publisher;

Game.App.prototype.init = function(param)
{
	param = param || {};	
...
//Core run loop
Game.App.prototype.run = function()
{
	this.update();
...
Game.App.prototype.update = function()
{
	var i, len;
...
// Add/remove objects
Game.App.prototype.addObject = function(obj)
{
...
Game.App.prototype.removeObject = function(obj)
{
...
// Event handling
Game.App.prototype.initMouse = function()
{
...
Game.App.prototype.initKeyboard = function()
{
	var dom = this.renderer.domElement;
...
Game.App.prototype.addDomHandlers = function()
{
	var that = this;
	window.addEventListener( 'resize', function(event) { that.onWindowResize(event); }, false );
}

Game.App.prototype.onDocumentMouseMove = function(event)
{
...
Game.App.prototype.onDocumentMouseDown = function(event)
{
    event.preventDefault();
...
Game.App.prototype.onDocumentMouseUp = function(event)
{
    event.preventDefault();
...
Game.App.prototype.onDocumentMouseScroll = function(event, delta)
{
    event.preventDefault();
...
Game.App.prototype.objectFromMouse = function(pagex, pagey)
{
    ...
    if ( intersects.length > 0 ) {        	
		...
		return (this.findObjectFromIntersected(intersected.object, intersected.point, null));        	    	                             
    }
    else
    {
...
Game.App.prototype.findObjectFromIntersected = function(object, point, normal)
{
	if (object.data)
	{
...
Game.App.prototype.onKeyDown = function(event)
{
...
Game.App.prototype.onKeyUp = function(event)
{
	// N.B.: Chrome doesn't deliver keyPress if we don't bubble... keep an eye on this
	event.preventDefault();
...
Game.App.prototype.onKeyPress = function(event)
{
	// N.B.: Chrome doesn't deliver keyPress if we don't bubble... keep an eye on this
	event.preventDefault();
...
Game.App.prototype.onWindowResize = function(event) {
...
Game.App.prototype.focus = function()
{
...
// Game.Object - base class for all objects in our simulation
...
Game.Object.prototype = new Game.Publisher;

Game.Object.prototype.init = function()
{
}
...
Game.Object.prototype.setPosition = function(x, y, z)
{
	if (this.object3D)
	{
...
Game.Object.prototype.setScale = function(x, y, z)
{
	if (this.object3D)
	{
...
//setScale - scale the object
Game.Object.prototype.setVisible = function(visible)
{
...
Game.Object.prototype.setObject3D = function(object3D)
{
	object3D.data = this;
...
//Add/remove children
Game.Object.prototype.addChild = function(child)
{
...
Game.Object.prototype.removeChild = function(child)
{
...
Game.Object.prototype.getScene = function()
{
	var scene = null;
	if (this.object3D)
	{
...
Game.Object.prototype.getApp = function()
{
...
*/
Game.KeyCodes = {};
Game.KeyCodes.KEY_LEFT  = 37;
Game.KeyCodes.KEY_UP  = 38;
Game.KeyCodes.KEY_RIGHT  = 39;
Game.KeyCodes.KEY_DOWN  = 40;
Game.KeyCodes.KEY_SPACE = 32;
Game.KeyCodes.KEY_Q = 81;
Game.KeyCodes.KEY_A = 65;
Game.KeyCodes.KEY_W = 87;
Game.KeyCodes.KEY_S = 83;
Game.KeyCodes.KEY_E = 69;
Game.KeyCodes.KEY_D = 68;
Game.KeyCodes.KEY_R = 82;
Game.KeyCodes.KEY_F = 70;
